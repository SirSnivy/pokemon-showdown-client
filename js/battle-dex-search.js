...
var isDoublesOrBS=isVGCOrBS||this.formatType==='doubles';
var dex=this.dex;
...
if(this.formatType==='letsgo'||this.formatType==='stadium')tierSet=tierSet.slice(slices.Uber);else
...
getBaseResults=function getBaseResults(){var _this$formatType2;
if(!this.species)return this.getDefaultResults();
var dex=this.dex;
var species=dex.species.get(this.species);
var format=this.format;
...
if((_this$formatType2=this.formatType)!=null&&_this$formatType2.startsWith('dlc1'))lsetTable=lsetTable['gen8dlc1'];
while(learnsetid){
...
var speciesTypes=[];
var moveTypes=[];
for(var i=dex.gen;i>=species.gen&&i>=_move.gen;i--){
var genDex=Dex.forGen(i);
moveTypes.push(genDex.moves.get(_move.name).type);
